...
export default function getTopRatedRestaurants() {
  ...
  useBackHandler(navigation,'TopRatedRestaurants');
    ...
    <View style={{ flex: 1, backgroundColor: '#FFF', paddingHorizontal: 10 }}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={{ marginTop: hp(3), flex: 1 }}>
          {filteredCategories.length > 0 || getTopRated_restaurants?.length > 0 ? (
            <FlatList
              data={filteredCategories?.length !== 0 ? filteredCategories : getTopRated_restaurants}
              numColumns={2}
